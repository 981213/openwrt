...
define Device/cellc_rtl30vw
	...
	KERNEL = kernel-bin | gzip | fit gzip $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb | uImage lzma | pad-to 2048
	KERNEL_NAME := Image
	KERNEL_IN_UBI :=
	IMAGES := nand-factory.bin nand-sysupgrade.bin
...
define Device/devolo_magic-2-wifi-next
	...
	KERNEL_INITRAMFS := kernel-bin | gzip | fit gzip $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb | pad-to 64k |\
